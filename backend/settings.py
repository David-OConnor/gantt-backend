...
if ON_HEROKU:
    ...
    DEBUG = True
    SECRET_KEY = 'mjz#o&78*7i#9&pnbe(cem1m9)6e$+-62md+8!s%29xd3#z^k8'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    # todo not sure why I need cors headers to make this work.
    # 'corsheaders',
]
...
LOCAL_DB = 'postgres://david:test@localhost:5432/gantt'
